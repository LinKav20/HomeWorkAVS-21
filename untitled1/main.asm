...
?_042:  call    clock                                   ; 0B3A _ E8, FFFFFFFC(rel)
        ...
        fld     qword [?_082]                           ; 0C92 _ DD. 05, 00000468(d)
        ...
        push    ?_081                                   ; 0CB4 _ 68, 0000044F(d)
...
?_080:                                                  ; byte
        ...
        db 25H, 6CH, 66H, 20H, 73H, 65H, 63H, 2EH       ; 0446 _ %lf sec.
        db 00H                                          ; 044E _ .

?_081:                                                  ; byte
        db 54H, 68H, 65H, 20H, 70H, 72H, 6FH, 67H       ; 044F _ The prog
        db 72H, 61H, 6DH, 20H, 77H, 61H, 73H, 20H       ; 0457 _ ram was 
        db 65H, 6EH, 64H, 2EH, 0AH, 00H, 00H, 00H       ; 045F _ end.....
        db 00H                                          ; 0467 _ .
